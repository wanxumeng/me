...
<script>
    ...
    export default {
        ...
        components:{
            TakeComment,
            // CommentOn,
            CommentOn:()=>import("@/components/CommentOn")
        }
    }
</script>
<style>
    ...
    a{outline:0}
    .jyArea{width:755px;overflow:hidden;margin:0 auto;font-family:"Microsoft YaHei"}
    ...
    .userName{float:left;background:url(../assets/img/userBj.png) left center no-repeat;padding-left:15px;color:#000;font-size:14px;font-weight:bold}
    ...
    .handle a{text-decoration:none;float:left;margin-left:12px;background:url(../assets/img/icons.png) 0 0 no-repeat;height:18px;line-height:18px;padding-left:20px}
    ...
    .inputs{float:right;width:125px;height:37px;border:none 0;background:tranparent;background:url(../assets/img/takeSbmComment.png) left top no-repeat;cursor:pointer;opacity:.8}
